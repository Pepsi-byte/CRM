...
<script>
	...
	$("#create-customerName").typeahead({
		...
		$("#create-Stage").change(function(){
			...
			/**
			 * 目的是填写可能性，有了阶段stage，阶段和可能性之间的对应关系为pmap,
			 * 但是pmap是java语言的键值对关系，要转成js中的json形式的键值对关系
			 */

				//首先先将json装换好了，stage也可以在文本中获得
				//所以可以去除value
...
<%--	提交表单，新增一条交易--%>
	<form action="workbench/tran/save.do" method="post" id="tranForm" class="form-horizontal" role="form" style="position: relative; top: -30px;">
...
<%--				  <option>wangwu</option>--%>
			...
			<div class="col-sm-10" style="width: 300px;">
				<input type="text" class="form-control" id="create-amountOfMoney" name="cost">
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<select class="form-control" id="create-transactionType" name="transactionType">
				  <option></option>
				 <c:forEach var="tranType" items="${transactionType}">
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<input type="text" class="form-control" id="create-activitySrc" name="百度推广1">
				<input type="hidden" name="activityId" value="0329c1643f224c1182717e07931ed98d"/>
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
<%--				将这两项内容写死--%>
				<input type="text" class="form-control" id="create-contactsName" name="马云">
				<input type="hidden" name="contactsId" value="6f334d6468844a74923cf3d9a5b0de42"/>
			</div>
		</div>
