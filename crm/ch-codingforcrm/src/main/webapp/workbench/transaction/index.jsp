			...
			<div style="position: relative;top: 10px;">
				<table class="table table-hover">
					...
					<tbody>
						<tr>
							<td><input type="checkbox" /></td>
<%--							将内容写死，跳转到交易的详情信息页，发送一个传统请求--%>
							<td><a style="text-decoration: none; cursor: pointer;" onclick="window.location.href='workbench/tran/detail.do?id=e759b14c73d64d07b6622523bcc83f5d';">阿里巴巴1</a></td>
							<td>动力节点</td>
							<td>谈判/复审</td>
							<td>新业务</td>
							<td>zhangsan</td>
